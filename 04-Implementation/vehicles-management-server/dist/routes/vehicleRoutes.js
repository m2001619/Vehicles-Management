...
router
    ...
    .get("/getRequestedVehicles", (0, authController_1.restrictTo)("admin"), vehicleController_1.getRequestedVehicles)
    ...
    .patch("/blockActiveVehicle/:id", (0, authController_1.restrictTo)("admin"), vehicleController_1.blockActiveVehicle)
